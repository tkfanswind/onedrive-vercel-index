...
module.exports = {
  ...
  baseDirectory: '/Tetsuya Komuro/TK Music/Music/',
  ...
  footer:
    '<p align="center"><a href="https://tkfans.pw" target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/badge/tkfans%20One%20Drive-000000?logo=Apple&logoColor=FFFFFF" alt="tkfans"></a></p>',

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  protectedRoutes: ['/Music', '/Music[FLAC]'],
